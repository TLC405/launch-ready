...
export default function TimeTravelLab() {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="fixed top-0 left-1/4 w-96 h-96 bg-neon-pink/10 rounded-full blur-[150px] pointer-events-none" />
      <div className="fixed bottom-0 right-1/4 w-96 h-96 bg-electric-blue/10 rounded-full blur-[150px] pointer-events-none" />
